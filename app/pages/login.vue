...
onMounted(() => {
  if (route.query.error === 'oauth_failed') {
    formError.value = 'Sign-in failed. Please try again.'
  }
      ...
      <div :style="{ flex: '1', overflowY: 'auto', padding: '8px 0' }">
        ...
        <div :style="{ padding: '0 20px' }">
          ...
          <div :style="{ position: 'relative', textAlign: 'center', margin: '14px 0' }">
            ...
            <span :style="{ position: 'relative', background: 'var(--zm-paper)', padding: '0 10px', font: '500 11px var(--zm-font-mono)', textTransform: 'uppercase', color: 'var(--zm-fg-muted)', letterSpacing: '0.06em' }">or continue with</span>
          </div>
      ...
      <div :style="{ padding: '56px 32px', display: 'flex', alignItems: 'flex-start', justifyContent: 'center', background: 'var(--zm-paper)' }">
        <div :style="{ width: '100%', maxWidth: '440px' }">
          ...
          <div :style="{ background: 'var(--zm-white)', border: '1px solid var(--zm-border)', borderRadius: 'var(--zm-r-xl)', padding: '36px', boxShadow: 'var(--zm-shadow-md)' }">
            ...
            <p :style="{ font: '400 14px/1.5 var(--zm-font-body)', color: 'var(--zm-fg-muted)', margin: '0 0 20px' }">Pick how you'd like to sign in — password or a one-time code. Social options below.</p>
            ...
            <!-- Divider + SSO -->
            <ZmDivider label="or continue with" style="margin:16px 0" />
            <div :style="{ display: 'flex', flexDirection: 'column', gap: '8px' }">
              ...
              <button :style="{ width: '100%', height: '46px', padding: '0 16px', display: 'flex', alignItems: 'center', gap: '12px', background: 'var(--zm-white)', color: 'var(--zm-ink-950)', border: '1px solid var(--zm-border-strong)', borderRadius: 'var(--zm-r-md)', cursor: 'pointer', font: '600 14px var(--zm-font-body)', letterSpacing: '-0.005em' }" @click="startOAuth('linkedin')">
                ...
                <span :style="{ flex: '1', textAlign: 'center' }">Continue with LinkedIn</span>
                <span :style="{ width: '20px' }" />
              </button>
            </div>
          </div>
